  ...
  <div class="app-container">
    ...
    <div id="printTest" class="no-print">
      <el-table
        ...
        <el-table-column label="房间号" align="center" min-width="100" prop="ro_id" sortable>
          <template slot-scope="scope">
        ...
        <el-table-column label="实收金额" class-name="status-col" align="center" min-width="80">
          <template slot-scope="scope">
            <span>{{ scope.row.pay_reality_money }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="交易编号" class-name="status-col" align="center" min-width="250">
          <template slot-scope="scope">
