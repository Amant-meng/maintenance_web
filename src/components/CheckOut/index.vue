...
<script>
import { updateOrderInfo, getOrderInfo, addConsumerDetail, addBillDetail, getBillPcode, checkOut, getBalance, getConsumerGood, getbillDetailById, switchover, offLineAddBillDetail, offLineCheckOut, offLineGetBillDetail } from '@/api/checkout'
